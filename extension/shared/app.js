...
function sortInteractions(interactions, sortBy, sortOrder) {
  ...
  const comparators = {
    ...
    // ⚡ Bolt Optimization: Replaced localeCompare with standard operators for O(N log N) sorts. Expected impact: significantly faster string sorting with reduced CPU overhead.
