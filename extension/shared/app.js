        ...
        <div class="ek-section-head">
          ...
          <div class="ek-row-inline-end">
            <label class="ek-switch ${i.mockEnabled ? 'on' : ''}" title="Toggle mock behaviour">
              <input type="checkbox" ${i.mockEnabled ? 'checked' : ''} data-action="toggle-mock" data-id="${i.id}" aria-label="Toggle mock behaviour"/>
              <span class="ek-switch-track"></span>
...
function renderSettingsGeneral(s, isDevTools) {
  return `
      ...
      <div class="ek-settings-row">
        ...
        <label class="ek-switch ${s.autoOpenOnRefresh?'on':''}" title="Toggle auto-open popup on refresh">
          <input type="checkbox" ${s.autoOpenOnRefresh?'checked':''} data-a="auto-open" data-testid="auto-open-toggle" aria-label="Toggle auto-open popup on refresh"/>
          <span class="ek-switch-track"></span>
