  ...
  return `
    <div class="ek-header">
      <div class="ek-header-top">
        ...
        <div class="ek-menu">
          <button class="ek-btn ek-btn-ghost ek-btn-icon" data-action="toggle-menu" title="More actions" data-testid="menu-btn" aria-label="menu" aria-expanded="${!!state.menuOpen}">
