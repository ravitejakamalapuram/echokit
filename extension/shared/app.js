...
function renderSettingsLicense() {
  return `
      <div class="ek-settings-row">
        ...
        <button class="ek-btn ek-btn-danger" data-a="clear-all" data-testid="clear-all-btn" title="Wipe every recorded interaction across every scope" aria-label="Wipe every recorded interaction across every scope">Wipe</button>
      </div>
