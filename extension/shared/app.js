      ...
      <div class="ek-section">
        <div class="ek-section-head">
          ...
          <div class="ek-row-inline-end">
            <label class="ek-switch ${i.mockEnabled ? 'on' : ''}" title="Toggle mock enabled state for this API">
...
function renderSettingsGeneral(s, isDevTools) {
  return `
      ...
      <div class="ek-settings-row">
        ...
        <label class="ek-switch ${s.corsOverride?'on':''}" title="Toggle CORS override settings globally">
      ...
      <div class="ek-settings-row">
        ...
        <label class="ek-switch ${s.autoOpenOnRefresh?'on':''}" title="Toggle automatically opening popup when tab reloads">
