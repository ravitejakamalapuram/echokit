...
function renderDetail(i, conflicts) {
  ...
  return `
    ...
    <div class="ek-detail-body">
      ...
      <div class="ek-row-inline">
        <button class="ek-btn ek-btn-danger" data-action="delete-interaction" data-id="${i.id}" data-testid="delete-btn" title="Delete this mock completely" aria-label="Delete this mock completely">Delete this mock</button>
