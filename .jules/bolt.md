...
## 2024-10-25 - String Sorting Optimization
**Learning:** String.prototype.localeCompare acts as a severe performance bottleneck for string sorting optimizations in JavaScript, especially within O(N log N) array sort comparators.
**Action:** Use standard explicit comparison operators (e.g., a < b ? -1 : (a > b ? 1 : 0)) for properties like URLs or HTTP methods that don't need locale-aware collation.
